                        ...
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <div class="sparkline13-outline-icon">
                                    <span><a href="{{route('sliders.create')}}" class="btn btn-custon-rounded-two btn-danger">Create</a></span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="false" data-show-columns="true"  data-toolbar="#toolbar">
                                        ...
                                        @foreach($sliders as $slider)
                                            <tr>
                                                <td></td>
                                                <td>{{$slider->id}}</td>
                                                <td>{{$slider->name['uz']}}</td>
                                                <td>{{$slider->price}}</td>
                                                <td><img style="width: 100px; height:100px" src="{{'/'.$slider->img}}" alt=""></td>
